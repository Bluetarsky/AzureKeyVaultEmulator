...
namespace AzureKeyVaultEmulator.V7.Models
{
    ...
    public partial class IssuerParameters
    {
        ...
        /// <param name="certificateType">Certificate type as supported by the
        /// provider (optional); for example 'OV-SSL', 'EV-SSL'</param>
        ...
        /// <summary>
        /// Gets or sets certificate type as supported by the provider
