...
namespace AzureKeyVaultEmulator.V7.Models
{
    ...
    public partial class SasDefinitionAttributes
    {
        ...
        public SasDefinitionAttributes(bool? enabled = default(bool?), System.DateTime? created = default(System.DateTime?), System.DateTime? updated = default(System.DateTime?), string recoveryLevel = default(string))
        {
            Enabled = enabled;
            Created = created;
            Updated = updated;
